...
<a download="../uploads/<?php echo $row["title"]?>" href="../uploads/<?php echo $row["title"]?>" class="btn btn-danger">Download</a>
</td>
<!-- <td><button type="button" class="btn btn-danger" >Change Verification Status</button></td> -->
</tr>
<?php
}
?>
