    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>List of Verified Documents</h2></div>
                    <div class="col-sm-4">
                    <button type="button" onclick="window.location.href='addverform.php'">Add Verified Document</button>
                    </div>
                </div>
            </div>
            <table class="table table-bordered">
                <thead>
                    <tr>
                    <th>ID</th>
                        <th>Title of Verified Document</th>
...
<td><a href="../verified/<?php echo $row["title"]?>" class="btn btn-danger">View</a> 
<a download="../verified/<?php echo $row["title"]?>" href="../verified/<?php echo $row["title"]?>" class="btn btn-danger">Download</a>
</td>
</tr>
<?php
}
